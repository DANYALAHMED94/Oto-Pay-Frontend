...
const Contact = () => {
  return (
    <section className="bg-[#D9CFE3] 3xl:px-[70px] 2xl:px-[50px] xl:px-[40px] lg:px-[40px] md:px-[40px] px-6  text-black-600 body-font  flex justify-center items-center overflow-hidden  ">
        ...
        <div className=" w-full flex justify-center items-center lg:flex-row flex-col space-y-8 3xl:space-x-32 2xl:space-x-2 gap-8 xl:ml-0 lg:ml-0 md:ml-0  ml-0  ">
          <div className=" bg-[#D9CFE3]3xl:w-[1200px] 2xl:w-[1080px] xl:w-[486px] lg:w-[550px] w-full  p-4   mt-8  rounded-lg   flex justify-center items-center flex-col  relative overflow-hidden ">
            <div className="flex  p-2 justify-start   w-full  flex-col ">
              ...
              Elevate your well-being with the power of inspiration! Discover daily to keep you on track. Click now to get started on your ,
              </p>
            </div>
...
<div className="  w-full h-[72px] p-2 flex items-center lg:flex-row md:flex-row flex-col lg:justify-start  ">
                      ...
                      <input
                        ...
                        className="  bg-[#D9CFE3]  border border-[#866FA3] h-[50px] text-black dark:text-white w-full rounded-md"
                        type="text"
                  ...
                  <div className="w-full h-[72px] p-2 flex items-center lg:flex-row md:flex-row flex-col lg:justify-start ">
                      ...
                      <input
                        ...
                        className=" bg-[#D9CFE3]  border border-[#866FA3] h-[50px] text-[] text-[#5A4278]   w-full rounded-md"
                        type="email"
                  ...
                  <div className="w-full h-36 p-2 ">
                    <div className=" w-full h-full  space-y-2 xl:mt-0 lg:mt-0 md:mt-0 mt-12">
                      <input
                        id="text"
                        // placeholder="message"
                        className=" w-full h-full  bg-[#D9CFE3]  border border-[#866FA3] text-black  rounded-md  justify-start"
                        type="text"
          ...
          <div className="lg:w-[690px] lg:h-[489px] md:w-[450px] md:h-[600px] xl:block lg:block md:block hidden  flex justify-center items-center relative  ">
            <img
              alt="gallery"
