...
const Contact = () => {
  return (
    <section className="bg-[#D9CFE3] 3xl:px-[70px] 2xl:px-[50px] lg:py-10 xl:px-[40px] lg:px-[40px] md:px-[40px] px-6 text-black-600 body-font flex justify-center items-center overflow-hidden  ">
      <div className="container flex justify-center items-center">
        <div className=" w-full flex justify-center items-center lg:flex-row flex-col space-y-8 3xl:space-x-32 2xl:space-x-2 gap-8 xl:ml-0 lg:ml-0 md:ml-0 ml-0">
          <div className=" bg-[#D9CFE3]3xl:w-[1200px] 2xl:w-[1080px] xl:w-[486px] lg:w-[550px] w-full p-4 md:mt-8 mt-0 rounded-lg flex justify-center items-center flex-col  relative overflow-hidden ">
            <div className="flex p-2 justify-start w-full flex-col ">
              <h1 className="xl:text-3xl lg:text-2xl md:text-2xl text-[21px] leading-9 font-bold text-[#093E46] dark:text-white lg:text-start md:text-start text-center">
                Contact Us
              </h1>
              <p className="lg:leading-6 text-[14px] font-medium text-[#515151] dark:text-[#959CB1] lg:text-start md:text-start text-center md:mt-2 ">
                ...
                <form onSubmit={formik.handleSubmit} className=" w-full gap-4 ">
                  <div className="  w-full h-[72px] p-2 flex items-center lg:flex-row md:flex-row flex-col lg:justify-start  ">
                    <input
                      ...
                      className="  bg-white p-3 border border-[#866FA3] h-[50px] text-black dark:text-white w-full rounded-md"
                      type="text"
                  ...
                  <div className="w-full h-[72px] p-2 flex items-center lg:flex-row md:flex-row flex-col lg:justify-start ">
                    <input
                      ...
                      className=" bg-white p-3 border border-[#866FA3] h-[50px] text-[] text-[#5A4278]   w-full rounded-md"
                      type="email"
          ...
          <div className="lg:w-[690px] hidden md:pb-0 pb-5 lg:h-[489px] md:w-[450px] md:h-[600px] xl:block lg:block md:block justify-center items-center relative  ">
            <img
              alt="gallery"
