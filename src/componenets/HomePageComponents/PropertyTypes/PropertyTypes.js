  ...
  return (
    <section className="bg-[#F6F6F6] 3xl:px-[70px] 2xl:px-[50px] xl:px-[40px] lg:px-[40px] md:px-[40px] px-6  text-black-600 body-font flex justify-center items-center overflow-hidden ">
      <div className="choose container py-24  space-y-16 ">
        ...
        <div className="flex flex-wrap   justify-center justify-items-center   grid xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-col-1 3xl:gap-40 2xl:gap-x-16 xl:gap-x-7 xl:gap-y-12 lg:gap-x-32 lg:gap-y-20 md:gap-x-6 sm:gap-y-8  ">
