...
function PropertyCard({ properties }) {
  ...
  return (
    <>
      <div className="w-full h-full xl:p-[24px] lg:p-4  p-6 rounded-lg  bg-white-900 text-white  shadow-lg     bg-[#FFFFFF] flex  xl:flex-row flex-col xl:gap-[32px] lg:gap-4  gap-4">
