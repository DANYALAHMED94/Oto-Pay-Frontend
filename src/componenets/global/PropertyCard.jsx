...
function PropertyCard() {
  return (
    <div className="xl:w-[1200px] lg:w-[950px] md:pb-10 w-full h-auto p-[24px] mt-8 rounded-lg bg-white-900 text-white shadow-lg bg-[#FFFFFF] flex lg:flex-row flex-col gap-8 ">
      <div className="xl:w-[534px] w-full lg:h-auto h-64">
        <img
          alt="gallery"
      ...
      <div className="md:w-[586px] w-full h-auto space-y-[20px]">
        <div className="md:w-[586px] w-full space-y-[11px]">
          <div className="flex justify-between">
            <h2
              className=" 3xl:text-lg text-[28px] font-semibold leading-[28px] text-[#5A4278]  rounded-lg  title-font mb-2
      "
            >
              $8,827648
            </h2>
            {/* <button className="p-3 px-4 w-[160px] rounded-lg border gap-x-1 flex justify-center items-center border-[#312245]">
              <img src={update} alt="delete" />
              <p className="text-sm text-[#312245] font-semibold">
                Update Property
              </p>
            </button> */}
            <h1 className="text-[#CD2424] text-base font-medium">
              Marked as vacant
            </h1>
          </div>
          <div className="space-y-[4px]">
            <div className="flex flex-col gap-y-2 justify-between">
              <h2 className="  text-[#312245] text-base font-bold leading-[20px] ">
                Park View City, Washington
              </h2>
              <div className="bg-[#D9CFE3] rounded px-3 py-2 text-xs">
                <p className="uppercase text-[#312245]">
                  Property Number <span>1215262232NY</span>
                </p>
              </div>
            </div>
          ...
          <div className="flex xsm:gap-6 gap-2">
            <div className=" flex items-center">
              ...
              <p className="text-[#866FA3] xxsm:text-sm text-xs">4beds</p>
            </div>
            ...
            <div className=" flex  items-center">
              ...
              <p className="text-[#866FA3] xxsm:text-sm text-xs">2ba</p>
            </div>
            ...
            <div className=" flex  items-center">
              ...
              <p className="text-[#866FA3] xxsm:text-sm text-xs">
        ...
        <div className=" w-full md:h-[48px] h-auto flex md:flex-row flex-col lg:justify-start md:justify-start justify-center gap-[16px]  ">
          <button
            type="submit"
            className="flex justify-center gap-[8px] text-[#CD2424] dark:text-white md:w-[184px] w-full h-full border border-[#CD2424] hover:text-white hover:bg-gradient-to-b from-[#3799CC] to-[#374BCC]  rounded-md text-sm px-5 py-2.5 text-center  items-center dark:focus:ring-gray-500  mb-2 "
          >
            <svg
              width="25"
              height="25"
          ...
          <button
            type="submit"
            className="flex justify-center gap-[8px] text-[#0C8B3F] dark:text-white md:w-[184px] w-full h-full border border-[#0C8B3F] hover:text-white hover:bg-gradient-to-b from-[#3799CC] to-[#374BCC]  rounded-md text-sm px-5 py-2.5 text-center  items-center dark:focus:ring-gray-500  mb-2 "
          >
            <svg
              width="25"
              height="25"
          ...
          <button
            type="submit"
            className="flex justify-center gap-[8px] bg-[#17062F] text-white md:w-[184px] w-full h-full border border-[#17062F] hover:text-white hover:bg-gradient-to-b from-[#3799CC] to-[#374BCC]  rounded-md text-sm px-5 py-2.5 text-center  items-center dark:focus:ring-gray-500  mb-2 "
          >
            <svg
              width="25"
              height="25"
